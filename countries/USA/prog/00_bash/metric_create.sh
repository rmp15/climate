...
#Rscript ~/git/climate/countries/USA/prog/05_metrics_development/metrics_development_2.R $year $dname

# SEE ABOVE ABOUT LOCATION OF VARIABLES FOR PLOTTING FUNCTION
declare -a metrics=("mean" "meanc" "days_below_10" "days_above_30" "sd" "days_changing_by_5" "days_increasing_by_5" "days_decreasing_by_5" "number_of_min_3_day_above_99_upwaves" "number_of_min_3_day_below_99_downwaves")
