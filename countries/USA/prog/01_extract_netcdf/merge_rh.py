...
for year in years:
    ...
    year = year
    print('processing rh for ' + str(year))
    ...
    rh = combi.createVariable('rh', d2m_var.datatype, d2m_var.dimensions)
    rh.units = '%'
    rh.long_name = 'Relative humidity = the amount of water vapour present in air expressed as a percentage of the amount needed for saturation at the same temperature'
