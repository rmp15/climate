...
for (i in seq(length(years))) {
        if(type=='mean'){
                file.name <- paste0('../../output/metrics_development_county/',dname,'/',metric,'_',dname,'/county_summary_',metric,'_',dname,'_',years[i],'.rds')
        }
        if(type%in%c('max','min')) {
                file.name <- paste0('../../output/metrics_development_county/',dname,'/',metric,'_',dname,'/county_summary_',metric,'_',dname,'_',years[i],'_',type,'.rds')
        }
...
# save output
saveRDS(dat,paste0('../../output/metrics_development_county/',dname,'/',metric,'_',dname,'/county_summary_',metric,'_',dname,'_',year.start,'_',year.end,'.rds'))
