...
# save output
saveRDS(dat.at,paste0("../../output/multiyear_normals/",dname,"/",metric,'/county_longterm_normals_',var,'_',year.start,'_',year.end,'.rds'))
...
# save output
saveRDS(temp.state,paste0("../../output/multiyear_normals/",dname,"/",metric,'/state_longterm_normals_',var,'_',year.start,'_',year.end,'.rds'))
