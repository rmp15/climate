...
for(i in years) {
    ...
    dat.county <- readRDS(paste0('../../output/county_weighted_mean_summary/county_daily_era5/',dname,'/county_daily_',dname,'_',i,'.rds'))
...
# save output
saveRDS(dat.at,paste0("../../output/multiyear_normals_era5/",dname,"/",metric,'/county_longterm_nonnormals_',var,'_',year.start,'_',year.end,'.rds'))
...
# save output
saveRDS(temp.state,paste0("../../output/multiyear_normals_era5/",dname,"/",metric,'/state_longterm_nonnormals_',var,'_',year.start,'_',year.end,'.rds'))
