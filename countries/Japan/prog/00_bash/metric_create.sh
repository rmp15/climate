...
#Rscript ~/git/climate/countries/Japan/prog/04_county_weighted_mean_summary/county_weighted_mean_summary.R $year $dname $freq $num 
...
Rscript ~/git/climate/countries/Japan/prog/05_metrics_development/metrics_development.R $year $dname
...
:
# plots
Rscript ~/git/climate/countries/Japan/prog/06_plots/plots.R $year $dname $metric
...
:
# create climate region values
#Rscript ~/git/climate/countries/USA/prog/05_metrics_development/metrics_development_climate_region.R ${years[0]} ${years[-1]} $start $end $dname $metric
