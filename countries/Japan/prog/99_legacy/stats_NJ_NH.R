...
for (csv in yearlydata.csv) {
  ...
  st.points <- usa.merge[which(usa.merge$STATE_ABBR=='NJ'),]  #STATE
  state.abb <- "NJ"                                           #STATE
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NJ.1982-1986.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NJ.1982-1986.csv", header=TRUE)
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NJ.1982-1991.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NJ.1982-1991.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NJ.1982-1996.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NJ.1982-1996.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NJ.1982-2001.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NJ.1982-2001.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NJ.1982-2006.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NJ.1982-2006.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NJ.1982-2010.csv")
...
for (csv in yearlydata.csv) {
  ...
  # Extracts just one state's points
  st.points <- usa.merge[which(usa.merge$STATE_ABBR=='NH'),]  #STATE
  state.abb <- "NH"                                           #STATE
  fips <- st.points$state_fips[1]                             #STATE
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NH.1982-1986.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NH.1982-1986.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NH.1982-1991.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NH.1982-1991.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NH.1982-1996.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NH.1982-1996.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NH.1982-2001.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NH.1982-2001.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NH.1982-2006.csv")
...
m.stats.all.yr <- read.csv("m.stats.t2m.NH.1982-2006.csv", header=TRUE)
m.stats.all.yr <- m.stats.all.yr[-1]
...
write.csv(m.stats.all.yr, file="m.stats.t2m.NH.1982-2010.csv")
